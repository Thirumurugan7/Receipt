...
**Demo: [`demo/receipt-demo.mp4`](demo/receipt-demo.mp4)**, 3:18. Every figure in it came off a live run: real settlement, real escrow, real release and refund. [`DEMO.md`](DEMO.md) is the narration, and [`demo/README.md`](demo/README.md) explains how the film is rendered without recording a screen.
